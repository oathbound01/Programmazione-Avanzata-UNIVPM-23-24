...
- [UML diagrams](#-uml-diagrams)
  ...
  - [Route: /newGame](#route-newgame)
  - [Route: /game/:gameId](#route-getgame)
  - [Route: /move/:gameId](#route-makemove)
  - [Route: /history ](#route-getmoves)
  - [Route: /quit/:gameId](#route-quitgame)
  - [Route: /leaderboard](#route-leaderboard)
  - [Route: /credits ](#route-getcredits)
