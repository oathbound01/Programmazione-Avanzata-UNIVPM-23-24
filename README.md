...
After coping the project, you need to place a **<mark>.env</mark>** file inside the project directory:
```
DB_NAME=tictactoe
DB_USER=postgres
DB_PASSWORD=dbp
...
In this file, you also need to include the private key generated by [JWT](https://jwt.io/) using the RS256 algorithm..
...
```
Start the Docker Compose consisting of the application container and the PostgreSQL container whit this command:
```
docker-compose up
```
